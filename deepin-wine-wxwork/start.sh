...
APPVER="4.0.16.6007deepin21"
WINEPREFIX="${HOME}/.deepinwine/${BOTTLENAME}"
EXEC_PATH="c:/Program Files/WXWork/WXWork.exe"
EXEC_FILE="${WINEPREFIX}/drive_c/Program Files/WXWork/WXWork.exe"
START_SHELL_PATH="/opt/deepinwine/tools/run_v4.sh"
UPDATEAPP_INSTALLER="WXWork"
UPDATEAPP_VER="4.1.0.6007"
UPDATEAPP_INSTALLER_PATH="c:/Program Files/${UPDATEAPP_INSTALLER}/${UPDATEAPP_INSTALLER}-${UPDATEAPP_VER}.exe"
export MIME_TYPE=""
export DEB_PACKAGE_NAME="deepin-wine-wxwork"
