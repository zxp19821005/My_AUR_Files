...
BOTTLENAME="Deepin-YouKu"
APPVER="9.2.14.1001"
WINEPREFIX="${HOME}/.deepinwine/${BOTTLENAME}"
EXEC_PATH="c:/Program Files/YouKu/YoukuClient/YOUKU.exe"
EXEC_FILE="${WINEPREFIX}/drive_c/Program Files/YouKu/YoukuClient/YOUKU.exe"
START_SHELL_PATH="/opt/deepinwine/tools/run_v4.sh"
export MIME_TYPE=""
export DEB_PACKAGE_NAME="deepin-wine-youku"
