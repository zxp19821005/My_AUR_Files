...
BOTTLENAME="Deepin-BaiduTranslate"
APPVER="1.6.0"
WINEPREFIX="$HOME/.deepinwine/${BOTTLENAME}"
EXEC_PATH="C:/Program Files/baidu-translate-client/百度翻译.exe"
EXEC_FILE="${WINEPREFIX}/drive_c/Program Files/baidu-translate-client/百度翻译.exe"
START_SHELL_PATH="/opt/deepinwine/tools/run_v4.sh"
UPDATE_INSTALLER="baidu-translate"
UPDATE_VER="1.6.1"
UPDATE_INSTALLER_PATH="C:/Program Files/baidu-translate-client/${UPDATE_INSTALLER}-${UPDATE_VER}.exe"
export MIME_TYPE=""
export DEB_PACKAGE_NAME="deepin-wine-baidu-translate"
...
DeployApp() {
    ...
    rm -rf "${WINEPREFIX}"
    # run installer
    msg 0 "Launching ${UPDATE_INSTALLER_PATH} ..."
    env WINEDLLOVERRIDES="winemenubuilder.exe=d" ${START_SHELL_PATH} ${BOTTLENAME} ${APPVER} "${UPDATE_INSTALLER_PATH}" "$@"
