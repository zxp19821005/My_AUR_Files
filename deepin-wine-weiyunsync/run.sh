...
EXEC_FILE="${WINEPREFIX}/drive_c/Program Files/Tencent/WeiyunSync/Bin/weiyunsync.exe"
START_SHELL_PATH="/opt/deepinwine/tools/run_v4.sh"
UPDATEAPP_INSTALLER="WeiyunSync"
UPDATEAPP_VER="3.0.0.620"
UPDATEAPP_INSTALLER_PATH="c:/Program Files/Tencent/${UPDATEAPP_INSTALLER}/${UPDATEAPP_INSTALLER}-${UPDATEAPP_VER}.exe"
export MIME_TYPE=""
