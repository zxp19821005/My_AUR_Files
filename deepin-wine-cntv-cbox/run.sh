...
UPDATEAPP_INSTALLER="CBox"
UPDATEAPP_VER="5.1.2.1"
UPDATEAPP_INSTALLER_PATH="c:/Program Files/CNTV/${UPDATEAPP_INSTALLER}/bin/${UPDATEAPP_INSTALLER}-${UPDATEAPP_VER}.exe"
export MIME_TYPE=""
